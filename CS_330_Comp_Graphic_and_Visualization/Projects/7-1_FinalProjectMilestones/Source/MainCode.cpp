...
namespace
{
	...
	const char* const WINDOW_TITLE = "Daniel Gorelkin - CS330"; 
...
int main(int argc, char* argv[])
{
	...
	std::cout << "O - front orthographic 2D view\n";
	std::cout << "P - change toperspective 3D view\n\n";
	std::cout << "Scroll wheel\t  - adjust camera movement speed\n";
	std::cout << "Ctrl+Scroll wheel - adjust mouse/camera sesitivity\n\n";
