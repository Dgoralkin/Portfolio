// This file will hold the trips in a JSON format
...
export const trips = [
    {
        ...
        "description_details" : "Sed consequat libero ut turpis venenatis ut aliquam risus semper. Etiam convallis mi vel risus pretium sodales. Etiam nunc lorem ullamcorper vitae laoreet."
    } , {
        "code" : "DAWR210315",
        "name" : "Dawson's Reef",
        "length" : "4 nights / 5 days",
        ...
        "description_details" : "vulputate, vulputate at est. Morbi aliquet viverra metus eu consectetur. In lorem dui, elementum sit amet convallis ac, tincidunt vel sapien."  
    } , {
        "code" : "CLAR210621",
        "name" : "Claire's REEF",
        "length" : "4 nights / 5 days",
        "start" : "2025-09-17T08:00:00Z",
        ...
        "description_details" : "Vulputate eget libero. In hac habitasse platea dictumst. Integer purus justo, egestas eu consectetur eu, cursus in tortor. Quisque nec nunc ac mi ultrices iaculis."
    }
];